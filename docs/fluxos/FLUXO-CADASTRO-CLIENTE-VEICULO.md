...
Manual para cadastrar **clientes** (pessoas ou empresas) e **veículos** vinculados no OFICINA DO BETO ERP. Sem esses cadastros não é possível abrir Ordem de Serviço nem usar o portal do cliente.
