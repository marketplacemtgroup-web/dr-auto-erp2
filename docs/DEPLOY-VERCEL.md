...
|------------------|-------|-------------|
| **oficinadobeto-api** | `apps/api` | `https://oficinadobeto-api.vercel.app` |
| **oficinadobeto-erp** | `app` | `https://oficinadobeto-erp.vercel.app` |
| **oficinadobeto-portal** | `apps/portal` | `https://oficinadobeto-portal.vercel.app` |
...
| `SINGLE_TENANT` | `true` |
| `CORS_ORIGIN` | `https://oficinadobeto.vercel.app,https://oficinadobeto-portal.vercel.app` (sem `/` final, separado por vírgula) |
...
```
CORS_ORIGIN=https://oficinadobeto.vercel.app,https://oficinadobeto-portal.vercel.app
```
...
3. Portal → **Environment Variables** → `VITE_API_URL=https://oficinadobeto-api.vercel.app` (sem barra final)
