# Scalibur Oficinas — instância dedicada

Este deploy é **um sistema por empresa**, não um SaaS com várias oficinas no mesmo banco.

- **Empresa:** Scalibur Oficinas
- **Banco:** Supabase (projeto exclusivo da Scalibur)
...
|----------|----------------|
| `SINGLE_TENANT` | `true` |
| `DEFAULT_ORGANIZATION_NAME` | `Scalibur Oficinas` |
| `VITE_APP_NAME` | `Scalibur` |
| `VITE_APP_TAGLINE` | `Oficinas` |
