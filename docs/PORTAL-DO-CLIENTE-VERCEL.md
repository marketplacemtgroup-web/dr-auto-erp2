...
|---------|----------|----------------|
| **API** | Backend (não abre para o cliente) | `https://oficinadobeto-api.vercel.app` |
| **ERP (Dashboard)** | Oficina / equipe | `https://oficinadobeto-erp.vercel.app` |
| **Portal do Cliente** | Cliente final | `https://oficinadobeto-portal.vercel.app` |
...
- URL da API já publicada (ex.: `https://oficinadobeto-api.vercel.app`)
- URL do ERP já publicada (ex.: `https://oficinadobeto-erp.vercel.app`)

### 5.1 Criar o projeto do Portal

1. Acesse [vercel.com](https://vercel.com) → **Add New…** → **Project**.
2. Importe o repositório **oficina-do-beto** (ou o nome do seu repo).
...
```env
VITE_API_URL=https://oficinadobeto-api.vercel.app
VITE_DASHBOARD_URL=https://oficinadobeto-erp.vercel.app
...
3. Anote a URL gerada, ex.: `https://oficinadobeto-portal.vercel.app`
...
```env
CORS_ORIGIN=https://oficinadobeto-erp.vercel.app,https://oficinadobeto-portal.vercel.app
```
...
```env
VITE_API_URL=https://oficinadobeto-api.vercel.app
VITE_PORTAL_URL=https://oficinadobeto-portal.vercel.app
```
