...
export function normalizeReportsFull(report: ReportsFull): ReportsFull {
  return {
    ...
    financial: {
      ...
      cashProfit: report.financial.cashProfit ?? report.financial.result ?? 0,
      operationalProfit:
        report.financial.operationalProfit ?? report.financial.totalProfit ?? 0,
      operationalExpenses: report.financial.operationalExpenses ?? 0,
      nonOperationalExpenses: report.financial.nonOperationalExpenses ?? 0,
      orderGross: report.financial.orderGross ?? report.financial.revenue ?? 0,
      orderRevenue: report.financial.orderRevenue ?? report.financial.revenue ?? 0,
      partsCost: report.financial.partsCost ?? 0,
      outsourcedCost: report.financial.outsourcedCost ?? 0,
      lineDiscounts: report.financial.lineDiscounts ?? 0,
      cardFees: report.financial.cardFees ?? 0,
