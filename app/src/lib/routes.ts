...
export const routes = {
  ...
  financeiroLancamentos: "/dashboard/financeiro/lancamentos",
  financeiroContas: "/dashboard/financeiro/contas",
  financeiroFluxo: "/dashboard/financeiro/fluxo-caixa",
  financeiroTransferencias: "/dashboard/financeiro/transferencias",
  financeiroEmprestimos: "/dashboard/financeiro/emprestimos",
  financeiroConciliacao: "/dashboard/financeiro/conciliacao",
