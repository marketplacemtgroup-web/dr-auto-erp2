...
import OrganizationAddressFields, {
  emptyOrganizationAddress,
} from "../../components/settings/OrganizationAddressFields";
import { branding, subscription } from "../../lib/branding";
import { resolveAssetUrl } from "../../lib/assetUrl";
import { resolveAddressDisplay } from "../../lib/address";
...
export default function SettingsPage() {
  ...
  const orgAddress = resolveAddressDisplay(mainBranch(org) ?? {});
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            ...
            <div className="bg-white rounded-xl card-shadow p-5">
              ...
              <dl className="space-y-3 text-[13px]">
                ...
                <Row label="Endereco" value={orgAddress || undefined} />
